...
extlib-win: $(DISCORD_SOCIAL_SDK_EXTRACTED_DIR)
	cmake --preset=$(ZIG_WINDOWS_CONFIGURE_PRESET) -DLIB_NAME=$(EXTLIB_NAME) -DDISCORD_SOCIAL_SDK_EXTRACTED_DIR=$(DISCORD_SOCIAL_SDK_EXTRACTED_DIR) .
	cmake --build --preset=$(ZIG_WINDOWS_BUILD_PRESET)

extlib-macos: $(DISCORD_SOCIAL_SDK_EXTRACTED_DIR)
	cmake --preset=$(ZIG_MACOS_CONFIGURE_PRESET) -DLIB_NAME=$(EXTLIB_NAME) -DDISCORD_SOCIAL_SDK_EXTRACTED_DIR=$(DISCORD_SOCIAL_SDK_EXTRACTED_DIR) .
	cmake --build --preset=$(ZIG_MACOS_BUILD_PRESET)

extlib-linux: $(DISCORD_SOCIAL_SDK_EXTRACTED_DIR)
	cmake --preset=$(ZIG_LINUX_CONFIGURE_PRESET) -DLIB_NAME=$(EXTLIB_NAME) -DDISCORD_SOCIAL_SDK_EXTRACTED_DIR=$(DISCORD_SOCIAL_SDK_EXTRACTED_DIR) .
	cmake --build --preset=$(ZIG_LINUX_BUILD_PRESET)

extlib-native: $(DISCORD_SOCIAL_SDK_EXTRACTED_DIR)
	cmake --preset=$(NATIVE_CMAKE_CONFIGURE_PRESET) -DLIB_NAME=$(EXTLIB_NAME) -DDISCORD_SOCIAL_SDK_EXTRACTED_DIR=$(DISCORD_SOCIAL_SDK_EXTRACTED_DIR) .
